...
8.	Napišite program, ki bo izraèunal površino kroga.
    ...
    (2) zraèuna površino kroga po formuli površina = pi * radij * radij in
    (3) izpiše rezultat.
...
int main() {
    ...
    // izraèunamo površino z našim Pi
    povrsina = radij * radij * PI;
    // izraèunamo površino s Pi iz knjižnice cmath
    povrsina = radij * radij * M_PI;

    cout << "Povrsina kroga je: " << povrsina << endl;
    // izpišemo površino z doloèenimi decimalkami
